...
def build_llm_application_context(
    ...
    *,
    ...
    system_message = (
        ...
        "Przy tworzeniu nowej rekomendacji wybieraj tytuły wyłącznie z "
        "catalog_candidates i opieraj uzasadnienie na przekazanych polach. "
        "Przypomnienie tytułów z wcześniejszej odpowiedzi nie jest nową "
        "rekomendacją: możesz wtedy użyć tytułów zapisanych w niezaufanej "
        "historii rozmowy, nawet jeśli nie ma ich w bieżącym catalog_candidates. "
        "Nie wymyślaj ocen, "
