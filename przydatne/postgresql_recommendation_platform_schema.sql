...
-- Platforma rekomendująca filmy i seriale z wykorzystaniem agentów LLM
--
-- Założenia:
-- 1. PostgreSQL przechowuje dane trwałe.
-- 2. Redis będzie dodany osobno jako cache / magazyn sesji.
-- 3. TMDB jest zewnętrznym źródłem metadanych.
-- 4. Tabela app_user reprezentuje użytkownika aplikacji.
--    Przy integracji z Django można ją zastąpić tabelą własnego
--    modelu AUTH_USER_MODEL i odpowiednio zmienić klucze obce.
-- ============================================================
...
-- ============================================================
-- RECOMMENDATION REQUESTS AND RUNS
-- ============================================================
...
-- GIN indexes for JSONB fields that may be searched/filterd.
...
-- ============================================================
-- OPTIONAL: automatic updated_at helper
-- ============================================================
